...
from interface.trading.miniqmt_interface import miniqmt, get_miniqmt_status
from backend.utils.notification_service import notification_service

# 导入TDX数据源（如果可用）
try:
    from interface.data.smart_monitor_tdx_data import SmartMonitorTDXDataFetcher
    TDX_AVAILABLE = True
except ImportError:
    TDX_AVAILABLE = False
...
class StockMonitorService:
    ...
    def get_scheduler(self):
        """获取调度器实例"""
        from backend.strategies.monitor.monitor_scheduler import get_scheduler
