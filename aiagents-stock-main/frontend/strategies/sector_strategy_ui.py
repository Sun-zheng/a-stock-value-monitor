...
from backend.strategies.sector_strategy.sector_strategy_data import SectorStrategyDataFetcher
from backend.strategies.sector_strategy.sector_strategy_engine import SectorStrategyEngine
from backend.utils.sector_strategy_pdf import SectorStrategyPDFGenerator
from database.managers.sector_strategy_db import SectorStrategyDatabase
from backend.strategies.sector_strategy.sector_strategy_scheduler import sector_strategy_scheduler
...
def display_analysis_tab():
    ...
    with col1:
        ...
        from config.model_config import model_options as app_model_options
