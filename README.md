...
- ETF策略工具箱支持全市场筛选、轮动、组合配置、定投计划、溢价折价监控、持仓穿透、风险雷达、ETF对比、日报周报和机会池，详见 [docs/ETF_TOOLKIT_REQUIREMENTS_AND_ACCEPTANCE.md](docs/ETF_TOOLKIT_REQUIREMENTS_AND_ACCEPTANCE.md)。
...
网页中可进入“ETF板块”，运行“ETF策略工具箱”“指数基金研究”和“大盘ETF指数分析”。ETF策略工具箱会抓取真实ETF行情、历史日线、溢价折价、基金档案和持仓穿透数据；勾选“完成后发送邮件”或“完成后创建飞书文档”后，会复用现有交付配置发送总分总报告。
